...
(async () => {
  ...
  await page.goto('https://www.linkedin.com/in/wellington-cristi-vilela-santana-a48b1123/');
  ...
  const experiences = await page.$$eval('#experience-section ul > .ember-view', async (nodes) => {
    ...
    for (const node of nodes) {
      ...
      const endDateIsPresent = (endDatePart) ? endDatePart.trim().toLowerCase() === 'o momento' : false;
